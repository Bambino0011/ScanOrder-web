                    ...
                    <div className="footer-modal-content" onClick={e => e.stopPropagation()}>
                        ...
                        {activeModal === 'privacy' && (
                            <div className="footer-modal-body text-content">
                                ...
                                <p>En ScanOrder Horeca ("nosotros", "nuestro" o "la plataforma"), operada por <strong>Marouan Mrhassi</strong> y <strong>Daniel Shelyuzhko</strong>, nos tomamos muy en serio la privacidad de nuestros usuarios y clientes. Esta Política de Privacidad describe cómo recopilamos, utilizamos y protegemos su información personal cuando utiliza nuestro servicio, de acuerdo con el Reglamento General de Protección de Datos (RGPD) aplicable en la Unión Europea.</p>
